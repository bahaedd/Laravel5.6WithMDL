				...
				<main class=mdl-layout__content>
					<div class=hb-section>
						...
						<div class=hb-section__content>
							<h1 class="hb-color-light mdl-typography--display-1 mdl-typography--font-thin hb-margin-top-150 hb-margin-bottom-300 mdl-typography--text-center">Add Admin</h1>
						</div>
					</div>
											...
											<form role="form" method="POST" action="{{ url('/register') }}">
												...
												<div class="mdl-cell mdl-cell-12-col" style="width:100%">
													<div class="mdl-selectfield mdl-js-selectfield" tabindex=-1>
														<select name="libelle" id="libelle" class=mdl-selectfield__select>
