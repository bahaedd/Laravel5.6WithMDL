				...
				<main class=mdl-layout__content>
					...
					<div class="mdl-grid mdl-grid--no-fullwidth hb-margin-top-40">
						<div class="mdl-cell mdl-cell--12-col">
                            <h2 class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-typography--headline mdl-typography--font-light hb-margin-bottom-20 hb-margin-top-20">Administrateurs</h2>                            
							<table class="mdl-data-table mdl-js-data-table mdl-shadow--2dp hb-full-width hb-data-table hb-data-table--center hb-data-table--middle">
                            	...
                            	<tbody>
                                	...
                                	<tr>
                                    	...
                                    	<td>
                                        	<a href="{{ action('UtilisateursController@destroyAdmin',$user->id) }}" class="mdl-link">
                            ...
                            <div class="mdl-cell mdl-cell--24-col mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-typography--headline mdl-typography--font-light hb-margin-bottom-0 hb-margin-top-20">
                            	<a class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" href="{{ url('AddAdmin') }}"><i class="material-icons">add</i></a>
                            </div>
						</div>
					</div>
				</main>
