				...
				<main class=mdl-layout__content>
					<div class=hb-section>
						...
						<div class=hb-section__content>
							<h1 class="hb-color-light mdl-typography--display-1 mdl-typography--font-thin hb-margin-top-150 hb-margin-bottom-300 mdl-typography--text-center">Modify User</h1>
						</div>
					</div>
										...
										<div class=mdl-card__supporting-text>
											...
											<div class="mdl-textfield mdl-textfield--full-width mdl-textfield--floating-label mdl-js-textfield">
												...
												<input class=mdl-textfield__input type=text id=name >
                                                    		...
                                                    		<div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-tablet mdl-cell-4-col-phone">
											<div class="mdl-textfield mdl-textfield--full-width mdl-textfield--floating-label mdl-js-textfield">
												<label class=mdl-textfield__label for=price>Confirm Password</label> 
