				...
				<main class=mdl-layout__content>
					<div class=hb-section>
								...
								<div class="mdl-cell mdl-cell--12-col">
                                    <h2 class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-typography--headline mdl-typography--font-light hb-margin-bottom-20 hb-margin-top-20">Message Respond</h2>                            
									<div class="mdl-cell mdl-cell--12-col mdl-shadow--2dp" style=" border: 1px solid #EDEDED; border-radius:15px;">
										<div style="display:inline-block;margin:10px;">
											<h6 style="display:inline;margin-left:30px;">To : </h6>{{ $email }}
										</div>
										<div style="width:50%;margin-left:auto;margin-right:auto">
										<form method="post" action="{{ url('Messagerespond') }}">
											{{ csrf_field() }}
