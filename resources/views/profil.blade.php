                ...
                <div class="mdl-card-user2 mdl-cell mdl-cell--12-col mdl-shadow--6dp" style="marin-bottom:50px">
                    ...
                    <div class="mdl-card-user2--body" style="margin-top:20px;">
                        <div class="bold" style="font-size: 20px;">{{ $user->name }}
							<a href="{{ url('fournisseurmessage', $user->id) }}">
								<i class="fa fa-envelope icon material-icons" id="tooltip" style="margin-left:10px;margin-top:5px;font-size:20px;"></i>
								<p class="mdl-tooltip" for="tooltip">Send Message</p>
							</a>	
						</div>
